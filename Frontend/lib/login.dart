...
class _MyLoginState extends State<MyLogin> {
  ...
  void checkValues(){
    ...
    if(name==""||email==""||age==""||valueChose==""){
      ...
      submit(email, name, age);
    }
  }

  void submit(String email,String name,String age) async{
    UserCredential? credential;
    UIHelper.showLoadingDialog(context, "Thanks For giving us Information");
    try {
      credential= await FirebaseAuth.instance.createUserWithEmailAndPassword(email: email, password: 'ftimage@123');
    ...
    return Container(
      decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/8.jpg'),fit: BoxFit.cover,opacity: 0.7,         // Default: 0.5
        ...
        body: Stack(
          children: [
            ...
            SingleChildScrollView(
              child: Container(
                padding: EdgeInsets.only(top: MediaQuery.of(context).size.height*0.33,right: 30,left: 30),
                child: Column(
                  children: [
                    TextField(
