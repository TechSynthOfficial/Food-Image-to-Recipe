        ...
        Navigator.push(
            ...
            MaterialPageRoute(builder: (context) {
              return ShowImage(userModel: widget.userModel,
                  firebaseUser: widget.firebaseUser,prediction:_prediction,objects :_detectedObjects,ingred: _ingred, method:_meth );
            }));
      });
        // Navigator.push(
        //     context,
            ...
            children: [
              ...
              Container(
                ...
                child:  imageFile==null ? Container(
                    ...
                    padding: EdgeInsets.only(top: MediaQuery.of(context).size.height*0.12,right: 10,left: 10),
                    height: 450,
                    width: 300,
                    alignment: Alignment.center,
